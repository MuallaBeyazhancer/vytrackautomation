...
public class VyTrackUtilities {
    ...
    public static void selectMenuOption(WebDriver driver, String tab, String module) {
        // click on tab
        String tabXpath = "//span[@class='title title-level-1' and contains(text(), '"+tab+"')]"; // module they all have almost same locator
        //driver.findElement(By.xpath(tabXpath)).click();
        WebElement tabEl = driver.findElement(By.xpath((tabXpath)));
        BrowserUtils.hover(tabEl);

        // click on module
        String moduleXpath = "//span[@class='title title-level-2' and contains(text(), '"+module+"')]"; // submodule
